...
import 'package:payment_methods_module/credit_card.dart';
import 'package:payment_methods_module/credit_cards_concept_detail_page.dart';
...
class CreditCardConceptPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('NextinGo Payment Method Module'),
          elevation: 0,
